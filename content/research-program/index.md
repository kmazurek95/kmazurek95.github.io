...
Across four empirical projects (congressional speech, Dutch neighborhoods, European welfare states, and US counties), one result keeps showing up: institutional context outperforms individual and local conditions at every scale I have tested.
...
Different questions, different data, different countries, different scales. The consistency is what makes the finding worth building on.
...
I did not start with AI. I started with inequality, redistribution preferences, and welfare states. The empirical work pushed me toward AI because AI is the structural force that will test institutional configurations most severely in the coming decades, and it does so through multiple channels at once.

## Why AI is the right shock to study

### AI is a multi-channel distributional force

AI does not create one kind of distributional consequence. It creates several, through channels that interact:

- **Labor.** Cognitive-task displacement, reshaped task structures, precarious AI-training work on the supply side.
- **Energy.** Data center buildout absorbing grid capacity; regressive cost pass-through to households through current utility rate regulation.
- **Supply chains.** Mineral and critical-gas dependencies that expose national economies to geopolitical chokepoints they do not control.
...
The methodological foundation. Demonstrates that I can formulate a measurement problem (how do you operationalize "prominence"?), build a pipeline to study it at scale (F1 = 0.91, κ = 0.82), and produce interpretable results. The measurement-design thinking applies directly to AI evaluation rubric design. I rebuilt the entire pipeline after graduating because I knew it could be pushed further.
...
The current portfolio establishes a conditional pattern: institutional context moderates how distributional shocks translate into political outcomes. It does not yet establish an identified causal mechanism linking specific AI exposure to specific institutional drift or trust tipping. Testing that mechanism is the work of the forthcoming papers, not of the projects shipped to date.
...
**AI evaluation and governance readers.** Start with [What Political Science Can Teach AI Evaluation](/writing/essays/political-science-ai-evaluation/). The portfolio demonstrates construct-validity work on hard-to-measure concepts; the inside-the-industry experience supplies the applied context. I can design evaluation frameworks, not just execute them.

## Principles

- **Research questions beat technical demonstrations.** A model of county-level swing is a research contribution. A benchmark is a tool.
