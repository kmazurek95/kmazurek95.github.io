---
title: "The price of being a target"
subtitle: "AI products are now specific enough that state adversaries name them"
date: 2026-03-27
type: "Essay"
summary: "The IRGC's April target list moved cloud infrastructure targeting from category to roster. The defensive posture hyperscalers now need flows through cloud pricing, siting decisions, and the same ratepayer socialization mechanisms that produced the energy cost channel. The Two Channels framework gains a new upstream driver."
tags: ["Geopolitics", "Policy", "AI Evaluation"]
weight: 2
---
...
Third, and this is the argument that belongs in a distributional analysis: the costs of militarizing cloud infrastructure do not stay in the defense budget. They flow through cloud pricing, through siting decisions, and through the ratepayer socialization mechanisms that have already produced the energy cost channel documented in [earlier work](/writing/essays/the-energy-channel/). The [Two Channels framework](/writing/essays/the-energy-channel/) this work has been making needs a small addition. Channel 1 has a new upstream driver. The AI economy's physical infrastructure is now carrying a military security premium, and the mechanism for paying that premium runs through the same residential utility bills that were already rising.
